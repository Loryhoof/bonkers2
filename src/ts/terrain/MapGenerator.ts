...
export default class MapGenerator {
    ...
    constructor(scene: THREE.Scene) {
        ...
        this.terrainData = new TerrainData(20, 1) // meshHeightMulitplier, scale // height 50
        ...
        this.worker = new Worker(new URL('./workers/worker.js', import.meta.url as any), { type: "module" })
